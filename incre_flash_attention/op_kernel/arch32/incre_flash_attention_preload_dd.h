...
protected:
    ...
    // Standalone bisheng: EVENT_ID4..7 may not be in scope before intrinsics; use enum values (event_t order).
    static constexpr uint32_t L1V_EVENT0 = 4;
    static constexpr uint32_t L1V_EVENT1 = 5;
    static constexpr uint32_t L1V_EVENT2 = 6;
    static constexpr uint32_t L1V_EVENT3 = 7;

    // m <> mte1
    static constexpr uint32_t L0A_EVENT0 = EVENT_ID3;
    static constexpr uint32_t L0A_EVENT1 = 4;
    static constexpr uint32_t L0B_EVENT0 = 5;
    static constexpr uint32_t L0B_EVENT1 = 6;

    // fix <> m
    static constexpr uint32_t L0C_EVENT0 = EVENT_ID3;
    static constexpr uint32_t L0C_EVENT1 = 4;
