...
bisheng \
  ...
  --npu-arch=dav-2201 \
  -I"${SCRIPT_DIR}/kernels/utils/kernel" \
  -I"${SCRIPT_DIR}/kernels/utils/kernel/iterators" \
  -I"${SCRIPT_DIR}" \
  ...
  "${SCRIPT_DIR}/incre_flash_attention_wrapper.cpp" \
  -o "${SCRIPT_DIR}/incre_flash_attention_lib.so"
