...
Rounded TFLOP/s from `benchmark_mla_prefill.csv`; exact floats are in the CSV.

| Case | B | H | Q len | KV len | MLA TFLOP/s | Fused TFLOP/s |
|------|--:|--:|------:|-------:|------------:|--------------:|
...
On this run, peak **~117 TFLOP/s** (attn-128 basis) appears at **B4×H16, Q=KV=2048** for both paths; large **B16×H32×1024** remains in the low‑90s TFLOP/s range at ~2.8–2.9 ms latency.
